...
class DepartamentoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $datos = [
            ...
            ['name' => 'RESTAURANTE - KATOK'],
            ['name' => 'RESTAURANTE - KAY'],
            ['name' => 'RESTAURANTE - KU´UK'],
            ['name' => 'RESTAURANTE - KUKULKAN'],
            ['name' => 'RESTAURANTE - MAIKO'],
            ['name' => 'RESTAURANTE - MASHUA'],
            ['name' => 'RESTAURANTE - MEDITERRANEO'],
            ['name' => 'RESTAURANTE - PISCIS'],
            ['name' => 'RESTAURANTE - PORTOFINO'],
            ['name' => 'RESTAURANTE - TEQUILA'],
            ['name' => 'RESTAURANTE - THE TRUCK'],
            ['name' => 'RESTAURANTE - TIKALITO'],
            ['name' => 'RESTAURANTE - YALKU'],
