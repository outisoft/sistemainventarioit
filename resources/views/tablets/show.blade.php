    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">
                    <a href="{{ route('tablets.index') }}" class="btn-ico" data-toggle="tooltip" data-placement="top"
                        title="Regresar">
                        <span>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" name="operario" class="form-control"
                                            value="{{ $tablet->operario }}" disabled />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" name="password" class="form-control"
                                            value="{{ $tablet->password }}" disabled />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" name="numero_tableta" class="form-control"
                                            value="{{ $tablet->numero_tableta }}" disabled />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" name="numero_telefono" class="form-control"
                                            value="{{ $tablet->numero_telefono }}" disabled />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" name="politica" class="form-control"
                                            value="{{ $tablet->politica }}" disabled />
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md">
                                            <div class="form-check form-check-inline mt-3">
                                                <input class="form-check-input" type="radio" name="configurada" id="configurada" value="1" {{ $tablet->configurada == '1' ? 'checked' : '' }} disabled/>
                                                <label class="form-check-label" for="configurada">Si</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="configurada" id="configurada" value="0" {{ $tablet->configurada == '0' ? 'checked' : '' }} disabled/>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md">
                                            <div class="form-check form-check-inline mt-3">
                                                <input class="form-check-input" type="radio" name="carta_firmada" id="carta_firmada" value="1" {{ $tablet->carta_firmada == '1' ? 'checked' : '' }} disabled/>
                                                <label class="form-check-label" for="carta_firmada">Si</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="carta_firmada" id="carta_firmada" value="0" {{ $tablet->carta_firmada == '0' ? 'checked' : '' }} disabled/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" name="personalsdscode" class="form-control"
                                            value="{{ $tablet->personalsdscode }}" disabled />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" name="folio_baja" class="form-control"
                                            value="{{ $tablet->folio_baja }}" disabled />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="observacion" class="form-control" type="textarea"
                                            ...
                                            autocomplete="observacion" rows="4"> {{ $tablet->observacion }}
                                        </textarea>
                                    ...
                                    <a href="{{ route('tablets.edit', $tablet->id) }}" class="btn btn-primary">
