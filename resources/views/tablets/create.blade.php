...
<div class="col-lg-4 col-md-6">
    <form method="POST" action="{{ route('tablets.store') }}">
        @csrf
        <div class="mt-3">
            <!-- Modal 1-->
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!-- Giacode -->
                            <div class="mb-3">
                                <x-input-label class="form-label" for="giacode" :value="__('Giacode')" />
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text">
                                        <i class='bx bxs-barcode' ></i>
                                    </span>
                                    <x-text-input id="giacode" class="form-control" type="text"
                                        name="giacode" placeholder="EVELIN" :value="old('giacode')" required
                                        autocomplete="giacode" />
                                </div>
                            ...
                            <!-- personalsdscode -->
                            <div class="mb-3">
                                <x-input-label class="form-label" for="personalsdscode" :value="__('Personalsdscode')" />
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text">
                                        <i class='bx bx-barcode' ></i>
                                    </span>
                                    <x-text-input id="personalsdscode" class="form-control" type="text"
                                        name="personalsdscode" placeholder="EVELIN" :value="old('personalsdscode')" required
                                        autocomplete="personalsdscode" />
                                </div>
