                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="no_employee" id="no_employee"
                                        class="form-control @error('no_employee') is-invalid @enderror"
                                        value="{{ old('no_employee') }}" required>
                                    @error('no_employee')
                            ...
                            @else
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="position_choice"
                                            id="choice_new" value="new"
                                            {{ old('position_choice', 'new') == 'new' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="choice_new">Crear Puesto Nuevo</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="position_choice"
                                            id="choice_existing" value="existing"
                                            {{ old('position_choice') == 'existing' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="choice_existing">Usar Puesto Existente (sin
                                            asignar)</label>
                                    </div>
                                </div>
                                ...
                                <div id="existing_position_fields">
                                    <div class="mb-3">
                                        ...
                                        <select name="position_id_existing" id="position_id_existing"
                                            class="form-select @error('position_id_existing') is-invalid @enderror">
                                            <option value="" disabled selected>Seleccione un puesto disponible...
                                            </option>
                                            @foreach ($unassignedPositions as $position)
                                                <option value="{{ $position->id }}"
                                                    {{ old('position_id_existing') == $position->id ? 'selected' : '' }}>
                                                    {{ $position->position }} - ({{ $position->email }}) -
                                                    [{{ $position->region->name ?? 'N/A' }}]
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('position_id_existing')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div id="new_position_fields">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <select name="hotel_id" id="hotels_id"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="departamento_id" id="department_id"
