<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                id="name" name="name" value="{{ old('name', $switch->name ?? '') }}" required>
        @error('name')
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" class="form-control @error('idf') is-invalid @enderror" 
                id="idf" name="idf" value="{{ old('idf', $switch->idf ?? '') }}">
        @error('idf')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <select class="form-select @error('location_id') is-invalid @enderror" id="location_id" name="location_id">
            ...
            @foreach($locations as $location)
                <option value="{{ $location->id }}" {{ old('location_id', $switch->location_id ?? '') == $location->id ? 'selected' : '' }}>
                    {{ $location->name }}
                </option>
            @endforeach
        </select>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('brand') is-invalid @enderror" 
                    id="brand" name="brand" value="{{ old('brand', $switch->brand ?? '') }}" required>
            @error('brand')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('model') is-invalid @enderror" 
                    id="model" name="model" value="{{ old('model', $switch->model ?? '') }}" required>
            @error('model')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="row">
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control @error('serial') is-invalid @enderror" 
                    id="serial" name="serial" value="{{ old('serial', $switch->serial ?? '') }}" required>
            @error('serial')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control @error('mac') is-invalid @enderror" 
                    id="mac" name="mac" value="{{ old('mac', $switch->mac ?? '') }}" required>
            @error('mac')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control @error('ip') is-invalid @enderror" 
                    id="ip" name="ip" value="{{ old('ip', $switch->ip ?? '') }}" required>
            @error('ip')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
            <div class="form-text">Debe ser única.</div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <div class="input-group">
                <input type="password" class="form-control @error('password') is-invalid @enderror" 
                        id="password" name="password" value="{{ old('password', $switch->password ?? '') }}">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <select class="form-select @error('tipo') is-invalid @enderror" id="tipo" name="tipo" required>
                <option value="idf" {{ old('tipo', $switch->tipo ?? 'idf') == 'idf' ? 'selected' : '' }}>IDF</option>
                <option value="principal" {{ old('tipo', $switch->tipo ?? '') == 'principal' ? 'selected' : '' }}>Principal</option>
                <option value="secundario" {{ old('tipo', $switch->tipo ?? '') == 'secundario' ? 'selected' : '' }}>Secundario</option>
            </select>
            @error('tipo')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
    ...
    <div id="connectionFields" class="connection-fields">
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <select class="form-select @error('connected_to_id') is-invalid @enderror" id="connected_to_id" name="connected_to_id">
                    <option value="">Seleccionar switch</option>
                    @foreach($switches as $s)
                        @if(!isset($switch) || $s->id != $switch->id)
                            <option value="{{ $s->id }}" {{ old('connected_to_id', $switch->connected_to_id ?? '') == $s->id ? 'selected' : '' }}>
                                {{ $s->name }} ({{ $s->tipo }})
                            </option>
                        @endif
                    @endforeach
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control @error('connected_port') is-invalid @enderror" 
                        id="connected_port" name="connected_port" value="{{ old('connected_port', $switch->connected_port ?? '') }}">
