...
@foreach ($accessPoints as $equipo)
    <div class="modal fade" id="editModal{{ $equipo->id }}" role="dialog" tabindex="-1"
        aria-labelledby="editModal{{ $equipo->id }}" aria-hidden="true"7>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <x-text-input id="edit_name" class="form-control" type="text" name="name"
                                    placeholder="SW-123" value="{{ $equipo->name }}" required autocomplete="name" />
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <x-text-input id="edit_marca" class="form-control" type="text" name="marca"
                                    placeholder="CISCO" value="{{ $equipo->marca }}" required autocomplete="marca" />
                            </div>
                            <x-input-error :messages="$errors->get('marca')" class="mt-2" />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <x-text-input id="edit_model" class="form-control" type="text" name="model"
                                    placeholder="45RT7" value="{{ $equipo->model }}" required autocomplete="model" />
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <x-text-input id="edit_serial" class="form-control" type="text" name="serial"
                                    placeholder="52RSCF78N93" value="{{ $equipo->serial }}" required
                                    autocomplete="serial" />
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                <x-text-input id="edit_mac" class="form-control" type="text" name="mac"
                            ...
                            <select class="form-control" id="edit_switch_id" name="swittch_id" required>
                                @foreach ($switches as $switch)
                                    <option value="{{ $switch->id }}"
                                        {{ $equipo->switch_id == $switch->id ? 'selected' : '' }}>
                                        {{ $switch->name }}
                                    </option>
                                @endforeach
                            </select>
