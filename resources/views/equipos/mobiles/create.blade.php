        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('mobiles.store') }}">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="modalCreate">Phone</h4>
                    ...
                    <div class="mb-3" style="display: none;">
                        ...
                        <div class="input-group input-group-merge">
                            <x-text-input readonly='readonly' id="tipo_id" class="form-control" type="text"
                                name="tipo_id" placeholder="Tablet" :value="12" required autocomplete="tipo_id" />
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <x-text-input id="model" class="form-control" type="text" name="model"
                                placeholder="GALAXI TAB" :value="old('model')" required autocomplete="model" />
                        </div>
