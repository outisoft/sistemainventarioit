                            ...
                            <form action="{{ route('equipo.update', $equipos->id) }}" method="POST" id="miFormulario">
                                ...
                                @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" id="nombre_app" name="nombre_app" class="form-control" value="{{ $equipos->nombre_app }}"  required/>
                                    </div>
                                    <div class="form-group">
                                        <label for="clave">Clave de activacion</label>
                                        <x-text-input type="text" id="clave" name="clave" class="form-control" value="{{ $equipos->clave }}"  required/>
                                    </div>
                            ...
                            <form action="{{ route('equipo.update', $equipos->id) }}" method="POST" id="miFormulario">
                                ...
                                @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" id="derie" name="serie" class="form-control" value="{{ $equipos->serie }}"  required/>
                                    </div>
                            ...
                            <form action="{{ route('equipo.update', $equipos->id) }}" method="POST" id="miFormulario">
                                ...
                                @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" id="orden" name="orden" class="form-control" value="{{ $equipos->orden }}"  />
                                    </div>
                                    <div class="form-group">
                                        <label for="marca">Marca</label>
                                        <x-text-input type="text" id="marca" name="marca" class="form-control" value="{{ $equipos->marca }}"  />
                                    </div>
                                    <div class="form-group">
                                        <label for="modelo">Modelo</label>
                                        <x-text-input type="text" id="modelo" name="modelo" class="form-control" value="{{ $equipos->modelo }}"  />
                                    </div>
                                    <div class="form-group">
                                        <label for="serie">Serie</label>
                                        <x-text-input type="text" id="serie" name="serie" class="form-control" value="{{ $equipos->serie }}"  />
                                    </div>
                                    <div class="form-group">
                                        <label for="nombre_equipo">Nombre de equipo</label>
                                        <x-text-input type="text" id="nombre_equipo" name="nombre_equipo" class="form-control" value="{{ $equipos->nombre_equipo }}"  />
                                    </div>
                                    <div class="form-group">
                                        <label for="ip">IP</label>
                                        <x-text-input type="text" id="ip" name="ip" class="form-control" value="{{ $equipos->ip }}"  />
                                    </div>
                                    <div class="form-group">
                                        <label for="no_contrato">Contrato</label>
                                        <x-text-input type="text" id="no_contrato" name="no_contrato" class="form-control" value="{{ $equipos->no_contrato }}"  />
                                    </div>
                            ...
                            <form action="{{ route('equipo.update', $equipos->id) }}" method="POST" id="miFormulario">
                                ...
                                @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" id="office" name="office" class="form-control" value="{{ $equipos->office }}"  required/>
                                    </div>
                                    <div class="form-group">
                                        <label for="clave">CLAVE DE ACTIVACION</label>
                                        <x-text-input type="text" id="clave" name="clave" class="form-control" value="{{ $equipos->clave }}"  required/>
                            ...
                            <form action="{{ route('equipo.update', $equipos->id) }}" method="POST" id="miFormulario">
                                ...
                                @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-text-input type="text" id="so" name="so" class="form-control" value="{{ $equipos->so }}"  required/>
                                    </div>
                                    <div class="form-group">
                                        <label for="clave">CLAVE DE ACTIVACION</label>
                                        <x-text-input type="text" id="clave" name="clave" class="form-control" value="{{ $equipos->clave }}"  required/>
