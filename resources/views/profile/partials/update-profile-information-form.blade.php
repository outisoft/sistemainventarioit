<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="d-flex align-items-start align-items-sm-center gap-4">
                <img src="{{ $user->image ? asset('/storage/avatars/' . $user->image) : $user->avatar }}" alt="Avatar"
        ...
        <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
                <x-text-input type="text" name="name" class="form-control" value="{{ $user->name }}" required
        ...
        <div class="form-group">
            ...
            <div class="input-group input-group-merge">
                <x-text-input type="email" name="email" class="form-control" value="{{ $user->email }}" required
    ...
    <form method="POST" action="{{ route('profile.remove-avatar') }}" id="remove-avatar-form" style="display: none;">
        @csrf
    </form>
</section>
