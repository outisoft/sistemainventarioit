                ...
                <div class="right">
                    <div class="text-wrap">
                        <p class="text-content">
                            <a class="text-link" href="#">{{ $equipo->tipo->name }}</a> CON NOMBRE
                            {{ $equipo->name }} CON LA IP
                            <a class="text-link" href="#">{{ $equipo->ip }}</a> .
                        </p>
                        <p class="time">DE LA MARCA {{ $equipo->marca }}, MODELO {{ $equipo->model }} Y NUMERO DE
                            SERIE {{ $equipo->serial }}</p>
                    </div>
                </div>
            </div>
        </div>
