                            ...
                            <div class="container">
                                ...
                                <label class="custom-file-upload">
                                    <input type="file" name="backup_file" id="backup_file"
                                        class="title @error('backup_file') is-invalid @enderror" required />
                                    Choose a file
                                </label>
                            </div>
                            <br>
                            <button type="submit" class="custom-file-restore">
                            ...
                            <div class="card-body">
                                <form action="{{ route('backup.restore') }}" method="POST"
                                    ...
                                    <div class="alert alert-info">
                                        <strong>Notas:</strong>
                                        <ul>
                                            <li>Se procesarán archivos ZIP que contengan archivos SQL o archivos SQL
                                                individuales.</li>
                                            <li>Las tablas deben existir en la base de datos.</li>
                                            <li>La estructura de las tablas debe coincidir con los datos a importar.
                                            </li>
                                        </ul>
                                    </div>
