...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" action="{{ route('sketchup.store') }}">
                @csrf
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">SketchUp</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3" style="display: none;">
                        ...
                        <div class="input-group input-group-merge">
                            <x-text-input readonly='readonly' id="type_id" class="form-control" type="text"
                                name="type_id" placeholder="Other" :value="18" required autocomplete="type_id" />
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="type" name="type" required>
                            <option value="">SELECT SKETCHUP</option>
