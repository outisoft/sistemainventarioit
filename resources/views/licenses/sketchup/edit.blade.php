    ...
    <div class="modal fade" id="editModal{{ $equipo->id }}" tabindex="-1" aria-labelledby="editModal{{ $equipo->id }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('sketchup.update', $equipo) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModal{{ $equipo->id }}">Edit SketchUp</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3" style="display: none;">
                            ...
                            <div class="input-group input-group-merge">
                                <x-text-input readonly='readonly' id="type_id" class="form-control" type="text"
                                    name="type_id" placeholder="Other" :value="18" required
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="type" name="type" required>
                                ...
                                <option value="SKETCHUP PRO" {{ $equipo->type == 'SKETCHUP PRO' ? 'selected' : '' }}>
                                    SKETCHUP PRO
                                </option>
                                <option value="SKETCHUP STUDIO"
                                    {{ $equipo->type == 'SKETCHUP STUDIO' ? 'selected' : '' }}>SKETCHUP STUDIO
                                </option>
                            </select>
