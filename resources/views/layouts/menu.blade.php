...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @can('switches.index')
            <li
                class="menu-item {{ Request::routeIs('switch.details') ? 'active' : '' }} || {{ Request::routeIs('ont.index') ? 'active' : '' }} || {{ Request::routeIs('switches.edit') ? 'active' : '' }} || {{ Request::routeIs('switches.show') ? 'active' : '' }} || {{ Request::routeIs('switches.index') ? 'active' : '' }} || {{ Request::routeIs('access-points.show') ? 'active' : '' }} || {{ Request::routeIs('access-points.index') ? 'active' : '' }}">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
