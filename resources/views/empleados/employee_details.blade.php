    ...
    <div class="container">
        ...
        <div class="right">
            <div class="text-wrap">
                ...
                <a class="text-link" href="#">{{ $equipo->tipo->name }}</a> CON NOMBRE {{ $equipo->nombre_equipo }} CON LA IP 
                <a class="text-link" href="#">{{ $equipo->ip }}</a> .
                </p>
                <p class="time">DE LA MARCA {{ $equipo->marca }}, MODELO {{ $equipo->modelo }} Y NUMERO DE SERIE {{ $equipo->serie }}</p>
            </div>
        </div>
    </div>
</div>
