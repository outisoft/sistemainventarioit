                    ...
                    <div class="navbar-nav align-items-center">
                        <div class="nav-item d-flex align-items-center">
                            @can('empleados.create')
                                <a href="#" class="btn-ico" data-toggle="modal" data-target="#modalCreate" data-placement="top" title="Agregar Nuevo Registro">
                                    <i class='bx bx-add-to-queue icon-lg'></i>
                                </a>
                                @if ($empleados->isEmpty())
                                    <a href="{{ url('importempleado') }}" class="btn-ico" data-toggle="tooltip" data-placement="top" title="Importar registros">
                                        <i class='bx bxs-cloud-upload icon-lg' ></i>
                                    </a>                            
                                @else
                                    <a href="{{ url('exportempleado') }}" class="btn-ico" data-toggle="tooltip" data-placement="top" title="Exportar registros">
                        ...
                        <form method="POST" action="{{ route('empleados.store') }}">
                            ...
                            <div class="mb-3">                                
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <x-text-input id="name" class="form-control" type="text" name="name" placeholder="Katrina Jones" :value="old('name')" required autocomplete="name" />
                  ...
                  <div class="table-responsive text-nowrap">
                    @if ($empleados->isEmpty())
                        <div style="text-align: center;">
                            <form action="{{ url('importempleado') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                                @csrf
